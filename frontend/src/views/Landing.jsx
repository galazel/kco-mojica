...
export default function Landing() {
  const menu = (
    <section className="grid grid-rows-[3rem_1fr] justify-center gap-10 h-full py-20">
      ...
      <div className="grid grid-cols-3 gap-10 w-[75vw] h-full ">
        {products.map((item, index) => {
          return (
            ...
            >
              <div className="bg-amber-900 h-[50vh]">
                <img
                  src={item.image}
                  alt={item.name}
              ...
              <div className="flex flex-col p-3 h-[17vh]">
                ...
                <Button className="w-full mt-3 cursor-pointer bg-green-950 h-12 hover:bg-green-700">Add to Cart</Button>
              </div>
            </div>
          );
        })}
